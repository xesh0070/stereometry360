...
def piramid_4():
    ...
    dashed_edges = [(3, 1), (5,4)]  # Оранжевые пунктирные линии
...
def run_pygame_tip3_pir1(e, stop_event_local):
...
def start_pygame(e):
    threading.Thread(target=run_pygame_tip3_pir1, args=(e,)).start()
